...
def add_metrics(df: pd.DataFrame, classes: List, dir: str, W):
    """
    ...
    for class_ in classes:
        ...
        for image in tqdm(image_list):
            ...
            mean_ref, std_ref = define_ref_im_attributes(config.IMAGES_PATH, classes, ref_image)
